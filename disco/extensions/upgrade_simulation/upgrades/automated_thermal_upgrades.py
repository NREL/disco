...
def determine_thermal_upgrades(
    ...
    perform_thermal_upgrades = thermal_config["perform_thermal_upgrades"]
    ...
    if perform_thermal_upgrades:
        ...
        commands_list =  []
        logger.info(f" Thermal upgrades disabled - upgrades not performed.")
