...
def get_file_list(directory, extension):
    """Get list of files that end with extension provided as parameter
    """
    file_list = []
...
def merge_pdf(pdf_list, output_filepath):
    """Merge multiple pdfs into one file, and delete the individual files.
    """
    import PyPDF2
    ...
    pdfOutput = open(output_filepath+".pdf", "wb")
    #Outputting the PDF
...
def analysis_postprocess():
    """Function to postprocess outputs at the end of the technical upgrades+costs
   - combines image pdfs into one file 
   - 
